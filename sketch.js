...
function masks() {
  var mask = createSprite(Math.round(random(windowWidth,windowHeight)), Math.round(random(0, 10)), 10, 10);
...
function viruses() {
  var virus = createSprite(Math.round(random(windowWidth,windowHeight)), Math.round(random(0, 10)), 10, 10);
...
function sanitizers() {
  var sanitizer = createSprite(Math.round(random(windowWidth,windowHeight)), Math.round(random(0, 10)), 10, 10);
